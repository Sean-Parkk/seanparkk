...
![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled.png)
...
![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%201.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%201.png)

- 그림과 같이 타깃값이 정렬되어있으면, 평가 시 문제 발생
- cross_val_score에선 분류일 경우는 **계층별 k-겹 교차 검증** 사용 (회귀는 단순 K-fold)
    - 폴드 안의 클래스 비율이 전체 클래스 비율과 같도록 나눔

        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%202.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%202.png)

- cv 매개변수에 교차 검증 분할기를 전달하여, 더 세밀하게 제어 가능

    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%203.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%203.png)
...
- LOOCV(Leave-one-out cross-validation)
    ...
    - 큰 데이터 셋에선 오래 걸리지만, 작은 데이터 셋에선 효과적
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%204.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%204.png)
...
- 임의 분할 교차 검증(shuffle-split cross-validation)
    ...
    - 이렇게 데이터를 부분 샘플링(subsampling)하는 방식은 대규모 데이터셋으로 작업 시 도움됨
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%205.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%205.png)
...
- 그룹별 교차 검증
    - 훈련 세트에 나온 그룹이 테스트 그룹에 나오지 않도록 조정
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%206.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%206.png)
...
- 따라서, 매개변수를 선택하는 세트를 나눠야함
    ...
    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%207.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%207.png)
...
```
![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%208.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%208.png)
...
- 매개변수도 훈련, 검증 세트를 여러 번 나눠서 교차 검증
    ...
    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%209.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%209.png)
...
- best_params_속성에 최적 매개변수, best_score_속성에 최상 교차 검증 점수 담김
    ...
    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2010.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2010.png)
...
- GridSearchCV
    ...
    - 교차 검증 결과는 cv_results_속성에 저장되어있음
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2011.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2011.png)
...
- 비대칭 매개변수 그리드 탐색
    ...
    - 이럴 때에는 딕셔너리로 매개변수 전달
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2012.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2012.png)
...
- 불균형 데이터셋(imbalanced datasets)
    ...
    - 이런 모델에서 99% 정확도로 예측하는 모델이 있다고 가정해보자
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2013.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2013.png)

> 오차 행렬(confusion matrix)

- 이진 분류 평가 결과를 나타낼 때 널리 사용되는 방법 중 하나

    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2014.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2014.png)

- 대각 행렬이 제대로 분류한 것
    - TN: 진짜 음성, TP: 진짜 양성 이라고도 함

    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2015.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2015.png)
...
- *f*₁-점수(*f*₁-score) 또는 *f*₁-측정(*f*₁-measure)
    ...
    - f1_score로 조회 가능
        ...
        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2016.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2016.png)

    - classification_report로 정밀도, 재현율, f1점수를 한 번에 출력도 가능

        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2017.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2017.png)

- 불확실성 고려
    - decision_function_에서 원래는 임계값이 0 이상이면 양성 클래스, 음수면 음성 클래스로 분류함
    - 근데 재현율을 높이는 것이 중요하다면, **임계값을 낮춰서** 더 많이 양성 클래스로 분류해야함

        ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2018.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2018.png)
    ...
    - 이를 위해서 **정밀도-재현율 곡선을 사용함(precision-recall curve)**
        - 타겟 레이블과 decision_function 혹은 predict_proba 메서드로 계산한 예측 불확실성 이용
            ...
            ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2019.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2019.png)
        ...
        - decision_function을 지원하지 않는 랜덤포레스트의 경우, predict_proba[:, 1]로 측정
            - 양성 클래스가 될 확률
                ...
                ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2020.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2020.png)
    ...
    - ROC와 AUC
        - ROC 곡선
            ...
            - FPR = FP / FP + TN
                ...
                ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2021.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2021.png)
...
- 이럴 때에는 GridSearchCV와 cross_val_score의 scoring 매개변수를 통해 손쉽게 구현 가능!
    ...
    ![https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2022.png](https://github.com/Sean-Parkk/seanparkk/blob/master/assets/images/5/Untitled%2022.png)
