...
[3. 통계 공부](#3.-통계-공부)
[4. 머신러닝/딥러닝](#4.-머신러닝/딥러닝)
[5. Python 라이브러리](#5.-Python-라이브러리)
[6. 알고리즘 공부](#6.-알고리즘-공부)
[7. 선형대수](#7.-선형대수)
[8. 데이터 분석 프로젝트](#8.-데이터-분석-프로젝트)
[9. 기타](#9.-기타)
- - - -
- - - -
## 0. 배경 (TMI)
...
내 생각: 고민만 하지 말고 뭐든 빨리 하자. 내 경우는 Python*
...
* 덤으로, 나는 아직 취업을 못했다.(ㅠㅠ)
* 코로나같은 변수는 변수대로 지나가게 두고,
* 꾸준히 공부하며 열심히 취준하는 우리는 우리만의 상수를 키워나가면서, 좋은 결과를 만들어봐요.
* 꼭이요!
